...
(function () {
  ...
  window.RECURKIT_LANGS = {
    ...
    en: {
      ...
      badge_next: 'Next: ',
      // Frequency labels
      flabel_once: 'One-time',
      flabel_daily: 'Daily', flabel_weekly: 'Weekly', flabel_monthly: 'Monthly',
      flabel_yearly: 'Yearly', flabel_every: 'Every', flabel_custom: 'Custom',
      // Dates
      ...
      notif_body_time: '{name} is due at {time} -- {mins} min heads up!',
      notif_body_now: '{name} is due now!',
      // Menu
      ...
      remind_at_time: 'At the time',
      remind_5min: '5 minutes before',
      remind_15min: '15 minutes before',
      remind_30min: '30 minutes before',
      remind_1hr: '1 hour before',
      remind_2hr: '2 hours before',
      // Statistics
      menu_stats: 'Statistics',
      stats_page_title: 'Statistics',
      stats_overview: 'Overview',
      stats_due_today_card: 'Due Today',
      stats_overdue_card: 'Overdue',
      stats_done_today_card: 'Done Today',
      ...
      stats_top_tasks: 'Most Completed',
    ...
    tr: {
      ...
      badge_next: 'Sonraki: ',
      flabel_once: 'Tek seferlik',
      flabel_daily: 'G\u00fcnl\u00fck', flabel_weekly: 'Haftal\u0131k', flabel_monthly: 'Ayl\u0131k',
      flabel_yearly: 'Y\u0131ll\u0131k', flabel_every: 'Her', flabel_custom: '\u00d6zel',
      ...
      notif_body_time: '{name} saat {time} -- {mins} dk sonra!',
      notif_body_now: '{name} şimdi yapılmalı!',
      ...
      label_reminder: 'Hat\u0131rlatma',
      remind_none: 'Hat\u0131rlatma yok',
      remind_at_time: 'Tam zaman\u0131nda',
      remind_5min: '5 dakika \u00f6nce',
      remind_15min: '15 dakika \u00f6nce',
      remind_30min: '30 dakika \u00f6nce',
      remind_1hr: '1 saat \u00f6nce',
      remind_2hr: '2 saat \u00f6nce',
      menu_stats: '\u0130statistikler',
      stats_page_title: '\u0130statistikler',
      stats_overview: 'Genel Bak\u0131\u015f',
      stats_due_today_card: 'Bug\u00fcn',
      stats_overdue_card: 'Gecikmi\u015f',
      stats_done_today_card: 'Tamamlanan',
      stats_last_7: 'Son 7 G\u00fcn',
      stats_by_type: 'T\u00fcre G\u00f6re',
      stats_streak: 'Mevcut Seri',
      stats_streak_days: 'g\u00fcn \u00fcst \u00fcste',
      stats_streak_day: 'g\u00fcn',
      stats_top_tasks: 'En \u00c7ok Tamamlanan',
      stats_completions: 'tamamlama',
      stats_no_data: 'Hen\u00fcz veri yok. G\u00f6revleri tamamlamaya ba\u015flay\u0131n!'
    },
    ...
    de: {
      ...
      freq_yearly: 'Jedes Jahr', freq_custom: 'Benutzerdefiniert...',
      ...
      label_every: 'Alle', custom_days: 'Tage', custom_weeks: 'Wochen', custom_months: 'Monate',
      ...
      badge_next: 'Nächste: ',
      flabel_once: 'Einmalig',
      flabel_daily: 'T\u00e4glich', flabel_weekly: 'W\u00f6chentlich', flabel_monthly: 'Monatlich',
      flabel_yearly: 'J\u00e4hrlich', flabel_every: 'Alle', flabel_custom: 'Benutzerdefiniert',
      ...
      notif_body_time: '{name} ist um {time} fällig -- noch {mins} Min!',
      notif_body_now: '{name} ist jetzt fällig!',
      ...
      remind_at_time: 'Zur Aufgabenzeit',
      remind_5min: '5 Minuten vorher',
      remind_15min: '15 Minuten vorher',
      remind_30min: '30 Minuten vorher',
      remind_1hr: '1 Stunde vorher',
      remind_2hr: '2 Stunden vorher',
      menu_stats: 'Statistiken',
      stats_page_title: 'Statistiken',
      stats_overview: '\u00dcbersicht',
      stats_due_today_card: 'Heute f\u00e4llig',
      stats_overdue_card: '\u00dcberf\u00e4llig',
      stats_done_today_card: 'Heute erledigt',
      stats_last_7: 'Letzte 7 Tage',
      stats_by_type: 'Nach Typ',
      stats_streak: 'Aktuelle Serie',
      stats_streak_days: 'Tage in Folge',
      stats_streak_day: 'Tag',
      stats_top_tasks: 'Am meisten erledigt',
      stats_completions: 'Erledigungen',
      stats_no_data: 'Noch keine Daten. Beginnen Sie, Aufgaben zu erledigen!'
    },
    ...
    fr: {
      ...
      label_every: 'Tous les', custom_days: 'jours', custom_weeks: 'semaines', custom_months: 'mois',
      btn_add: 'Ajouter',
      ...
      flabel_yearly: 'Annuel', flabel_every: 'Tous les', flabel_custom: 'Personnalis\u00e9',
      ...
      notif_body_time: '{name} est pr\u00e9vu \u00e0 {time} -- dans {mins} min !',
      notif_body_now: '{name} est d\u00fb maintenant !',
      ...
      remind_at_time: '\u00c0 l\u2019heure',
      remind_5min: '5 minutes avant',
      remind_15min: '15 minutes avant',
      remind_30min: '30 minutes avant',
      remind_1hr: '1 heure avant',
      remind_2hr: '2 heures avant',
      menu_stats: 'Statistiques',
      stats_page_title: 'Statistiques',
      stats_overview: 'Aper\u00e7u',
      stats_due_today_card: '\u00c0 faire',
      stats_overdue_card: 'En retard',
      stats_done_today_card: 'Fait',
      stats_last_7: '7 derniers jours',
      stats_by_type: 'Par type',
      stats_streak: 'S\u00e9rie actuelle',
      stats_streak_days: 'jours cons\u00e9cutifs',
      stats_streak_day: 'jour',
      stats_top_tasks: 'Les plus compl\u00e9t\u00e9es',
      stats_completions: 'compl\u00e9tions',
      stats_no_data: 'Pas encore de donn\u00e9es. Commencez \u00e0 compl\u00e9ter des t\u00e2ches !'
    }
  };
